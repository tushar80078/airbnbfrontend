...
const UserPlaces = () => {
  ...
  try {
    await axios.post('/admin/addrejectplace', {
    ...
    // Update the flag after the API call is successful
    setTimeout(() => {
    ...
    <div key={flag}>
      <div className="card">
        <div className="card-header">
          <h3 className="card-title">All Places For Given User</h3>
        </div>
        {/* /.card-header */}
